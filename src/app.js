...
app.get("/bootstrap.js", (_request, response) => response.type("application/javascript").send("window.__NAZOFT_AUTHENTICATED__=false;window.__NAZOFT_USER__=null;window.__NAZOFT_REMOTE_STATE__=null;"));
